        ...
        <div class="col-md-12">
            <div class="card mb-4">
                <div class="card-header">
                    <h3 class="card-title">ثبت بیمه</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                    <form action="{{ route('admin.insurances.store') }}" method="post">
                        ...
                        <div class="row">
                            <div class="col">
                               <div class="form-group">
                                   ...
                                   <input type="text" class="form-control" name="name" id="name" placeholder="نام بیمه را اینجا وارد کنید" value="{{ old('name') }}" required autofocus>
                               </div>
                            </div>
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="type" id="type" required>
                                        ...
                                        <option value="basic" @selected(old('type') == 'basic')>{{ __('app.basic') }}</option>
                                        <option value="supplementary" @selected(old('type') == 'supplementary')>{{ __('app.supplementary') }}</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" min="1" max="99" name="discount" id="discount" placeholder="درصد تخفیف را اینجا وارد کنید" value="{{ old('discount') }}" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row mt-2">
                            <div class="col text-center">
                                <button type="submit" class="btn btn-primary">ثبت بیمه</button>
                            </div>
                        </div>

    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card mb-4">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    <form action="{{ route('admin.insurances.update', $speciality->id) }}" method="post">
                        @csrf
                        @method('patch')
                        <div class="row">
                            <div class="col">
                               <div class="form-group">
                                   <label for="title">عنوان بیمه</label>
                        ...
                        <div class="row mt-2">
                            <div class="col text-center">
                                <button type="submit" class="btn btn-warning">ویرایش بیمه</button>
                            </div>
                        </div>
